                        ...
                        {subject.examFinal && (
                            <div style={{ display: 'flex', alignItems: 'baseline', cursor: 'pointer' }}>
                                <span 
                                    ...
                                    className={`${styles.selectorItem} ${subject.activeExam === 'F' ? styles.selectorItemActive : ''}`}
                                >
                                    Final
                                </span>
                        ...
                        {subject.examRecup && (
                            <div style={{ display: 'flex', alignItems: 'baseline', cursor: 'pointer' }}>
                                <span 
                                    ...
                                    className={`${styles.selectorItem} ${subject.activeExam === 'R' ? styles.selectorItemActive : ''}`}
                                >
                                    Recuperació
                                </span>
                        ...
                        <div style={{ display: 'flex', gap: '6px', cursor: 'pointer' }}>
                            {subject.teoriaInfo.map((grup: any, idx: number) => (
                                <span 
                                    ...
                                    className={`${styles.selectorItem} ${activeGroupIdx === idx ? styles.selectorItemActive : ''}`}
                                >
                                    {grup.sigles || grup}
                                </span>
                            ))}
                        ...
                        <div style={{ display: 'flex', gap: '6px', cursor: 'pointer' }}>
                            {subject.practiquesInfo.map((grup: any, idx: number) => (
                                <span 
                                    ...
                                    className={`${styles.selectorItem} ${activePractiquesIdx === idx ? styles.selectorItemActive : ''}`}
                                >
                                    {grup.sigles || grup}
                                </span>
                            ))}
