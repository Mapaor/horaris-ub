...
Nota: La manera utilitzada per trobar aquests endpoints de la API de la UB ha estat simplement anar a la web de la guia acadèmica i obrir l'inspector del navegador en la pestanya consola filtrant els esdeveniments XHR. Així al fer clic en una assignatura, en un pla docent... només cal que ens fixem en les URLs que apareixen, és a dir en les URLs a les que el navegador fa la petició.
