...
Nota: La manera utilitzada per trobar aquests endpoints de la API de la UB ha estat simplement anar a la web de la guia acadèmica, obrir l'inspector del navegador, i en la pestanya consola filtrar els esdeveniments XHR. Així al fer clic en una assignatura, en un pla docent, etc. Només cal fixar-se en les URLs que apareixen, és a dir en les quals el navegador fa la petició.
